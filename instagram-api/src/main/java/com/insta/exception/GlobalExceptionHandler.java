...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> UserExceptionHandler(UserException userException, WebRequest req) {
        ...
        ErrorDetails err = new ErrorDetails(userException.getMessage(), req.getDescription(false), LocalDateTime.now());
        return new ResponseEntity<ErrorDetails>(err, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(MethodArgumentNotValidException.class)
    public ResponseEntity<ErrorDetails> methodArguemntNotValidException(MethodArgumentNotValidException e) {
